...
- **Missile Rack, Test Range, and Icon:**
  - **Missile Rack Implemented**: The always-indirect Missile Rack weapon mount is fully functional - banks fed energy into a salvo of 2-5 lobbed shells (more at higher rarity) landing in a spread around your aim point, participating in the same charge/Accumulator-bank economy as a Weapon Mount. Registered in the Scrap Shop's rare-tile section.
