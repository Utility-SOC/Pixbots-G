...
const TILE_TYPE_BLURBS = {
	...
	"Chopper": "Adjacent to a Weapon Mount/Missile Rack: shaves down how long that mount takes to charge, making rapid fire cheaper - the inverse of Accumulator's slower-but-bigger tradeoff. Mythic: chops that mount's one combined shot into several smaller ones of the same total magnitude.",
