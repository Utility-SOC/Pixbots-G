...
const TILE_TYPE_BLURBS = {
	...
	"Missile Rack": "Always-indirect weapon mount - banks its fed energy into a salvo of lobbed shells that land in a spread around your aim point, more shells at higher rarity.",
